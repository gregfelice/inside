...
feature "Reporting relationships administration" do 
  ...
  #Test self is not in search lists

  #Test existing relationships are not in search lists

  #Test modal people search
